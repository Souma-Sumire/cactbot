...
export default class CombatantJobSearch {
  ...
  static readonly abilityMatchRegex = /[a-fA-F0-9]{1,4}/i;
    ...
    SGE: [
      ...
      24313, 24314, 24315, 24316, 24317, 24318, 37033, 37034, 37035,
    ],
    RPR: [
      ...
      24403, 24404, 24405, 24406, 36973,
    ],
    VPR: [
      34606, 34607, 34608, 34609, 34610, 34611, 34612, 34613, 34614, 34615,
      34616, 34617, 34618, 34619, 34620, 34621, 34622, 34623, 34624, 34625,
      34626, 34627, 34628, 34629, 34630, 34631, 34632, 34633, 34634, 34635,
      34636, 34637, 34638, 34639, 34640, 34641, 34642, 34643, 34644, 34645,
      34646, 34647, 35920, 35921, 35922,
    ],
    PCT: [
