...
type Phase = 'BOSS1-P1' | 'BOSS1-P2' | 'BOSS1-P3' | 'BOSS2-P2' | 'BOSS2-P2B' | 'BOSS2-P3';
...
const orientation = ['北', '南', '西', '东'] as const;
...
export interface Data extends RaidbossData {
  ...
  天界交叉斩麻将?: '点名' | '1' | '2';
  破绽?: string[];
  连线位置?: Record<string, string>;
  连线溯源?: Record<string, string>;
  连线时间?: number;
}
...
const boss2Debuffs: Record<string, string> = {
  '12A5': '东',
  '12A6': '西',
  '12A7': '东西',
  '12A8': '南',
  ...
  triggers: [
    ...
    },
    {
      ...
      alertText: (data, matches, output) => {
        ...
        return output[res[key as keyof typeof res]!]!();
      },
      outputStrings: {
        '单吃': { en: '单吃' },
        '分摊': { en: '分摊' },
    ...
    },
    {
      ...
      preRun: (data, matches) => {
        data.天界交叉斩麻将 = {
          ...
          '014C': '1',
          '014D': '2',
        }[matches.id as keyof typeof data.天界交叉斩麻将]!;
      },
    },
    {
      id: 'souma 剑术大师 轮轮残响',
    ...
    },
    {
      ...
      preRun: (data, matches) => {
        const dir = Directions.hdgTo4DirNum(parseFloat(matches.heading)) as 0 | 1 | 2 | 3;
